...
- Entire framework **generated by a 16-skill Claude Code pipeline** (no MCP): standalone specs → Page Object Model → Data-Driven → TypeScript → Cucumber BDD, each layer gated by its own review skill + run→debug→fix loop
